...
public class PrivacyPreservingTabuSearchForager<Solution_> extends AbstractPrivacyPreservingForager<Solution_>{
    ...
    public PrivacyPreservingTabuSearchForager(int acceptedCountLimit, NeighbourhoodEvaluator<Solution_> neighbourhoodEvaluator, int tabuListSize){
    ...
    protected boolean isAccepted(LocalSearchMoveScope<Solution_> stepWinner) {
        ...
        if(stepWinner.getScore().compareTo(stepWinner.getStepScope().getPhaseScope().getLastCompletedStepScope().getScore()) >= 0){
